        ...
        <div className="sticky-content container">
            <div className="content">
                <div className="single-blog-list" data-aos="fade-up">
                    <h4 className="single-blog-title">AutoCare Solutions - Tire Services</h4>
                    <p className="single-blog-desp">
                        ...
                        that your
                        tires are in optimal condition, providing you with the traction, handling, and comfort you
                        deserve.
                ...
                <div className="single-blog-list" data-aos="fade-up">
                    <h4 className="single-blog-title">1. Tire Rotation:</h4>
                    <p className="single-blog-desp">Regular tire rotation is essential for even tread wear and
                        longevity.
                ...
                <div className="single-blog-list" data-aos="fade-up">
                    <h4 className="single-blog-title">2. Tire Balancing:</h4>
                    <p className="single-blog-desp">Imbalanced tires can lead to uneven wear, vibrations, and handling
                ...
                <div className="single-blog-list" data-aos="fade-up">
                    <h4 className="single-blog-title">3. Wheel Alignment:</h4>
                    <p className="single-blog-desp">
                ...
                <div className="single-blog-list" data-aos="fade-up">
                    <h4 className="single-blog-title">4. Tire Repair:</h4>
                    <p className="single-blog-desp">
...
export default ServicesSingleArea;