    ...
    <div className="ak-bg">
        <div className="container">
            ...
            <div className="pricing type-two">
                <div className="pricing-card style-two" data-aos="fade-up">
                    <div className="pricing-heading">
                        <p className="title">Total Car Care</p>
                        <h2 className="discount-price">$299.99</h2>
                ...
                <div className="pricing-card style-two" data-aos="fade-up" data-aos-delay="50">
                    <div className="pricing-heading">
                        <p className="title">Performance Enhancement</p>
                        <h2 className="discount-price">$599.99</h2>
                ...
                <div className="pricing-card style-two" data-aos="fade-up" data-aos-delay="100">
                    <div className="pricing-heading">
