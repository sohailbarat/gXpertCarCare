...
const PriceHomeOne = ({style_2}: any) => {
  ...
  return (
    <>
        {style_2 ? null :<div className="ak-height-160 ak-height-lg-50"></div>}
        <div className="ak-bg" style={{backgroundImage: `url(/assets/img/pricing_bg.png)`}}>
            ...
            {style_2 ? null : <div className="ak-height-100 ak-height-lg-80"></div>}
        </div>
    </>
  );
};
