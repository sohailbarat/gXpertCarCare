        ...
        <div className="ceo-content type_2">
            ...
            <div className="right-info" data-aos="fade-right" data-aos-delay="800">
                <div className="ceo-title">
                    <div>
                        <h5 className="title">Michael Jack</h5>
                        <p className="short-title">Founder of Company</p>
                    </div>
                </div>
                <div className="ceo-desp">
                    <p className="desp">There are many variations of passages of Lorem Ipsum available, but the majority
                        have suffered alteration in some form injected humour, or randomised There are many
                        variations
                    ...
                    <ul className="address-list">
                        ...
                        <li><span>Email: </span>example@example.com</li>
...
export default SingleTeamAbout;